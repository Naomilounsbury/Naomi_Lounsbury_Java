...
//        input.put("answer", "");
    ...
    @Test
    public void shouldReturn422StatusCodeForStringInputsSubtract()throws Exception{
        // ARRANGE
        Map<String, String> input=new HashMap<>();
        input.put("operand1", "5");
        input.put("operand2", "this is a string");
    ...
    @Test
    public void shouldReturn422StatusCodeForStringInputsMultiply()throws Exception{
        // ARRANGE
        Map<String, String> input=new HashMap<>();
        input.put("operand1", "5");
        input.put("operand2", "this is a string");
